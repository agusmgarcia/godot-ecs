...
A class that extends a specific Godot node type and implements `IComponent`. All component boilerplate is generated; the hand-written source contains only the class declaration.
